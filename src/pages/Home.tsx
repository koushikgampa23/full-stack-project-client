...
const Home = () => {
  ...
  const getContent = listPosts ? listPosts.map((post, index) => {
    return (
          ...
          <div className={classnames(classes.title)}>
            <div className={classes.alignContent}>
              <Link
                ...
                className={classnames(classes.linkStyle, classes.alignContent)}
              >
  ...
  return <div className={classes.layout}>{getContent}</div>;
};
